...
@Getter
public class RankPrefixPrompt extends ValidatingPrompt {
    ...
    public RankPrefixPrompt(Player executor, Rank rank, Menu openMenu) {
        this.executor = executor;
        this.rank = rank;
        this.openMenu = openMenu;
    }

    public RankPrefixPrompt(Player executor, Rank rank, Prompt nextPrompt) {
        this.executor = executor;
        this.rank = rank;
